...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    tagline: "Vibrant cast & extruded acrylic for premium signage",
    features: [
      "High-gloss, clear & coloured grades",
      "Laser & router friendly",
      "Weather-stable, impact-resistant",
    ],
    applications: ["3D Letters", "Backlit Signage", "Displays"],
    weatherResistance: "Long-term indoor / outdoor",
    inStock: true,
    accentFrom: "#F472B6",
    accentTo: "#7C3AED",
    specs: [
      { label: "Thickness", value: "2–10 mm" },
      { label: "Finish", value: "Gloss / Frosted" },
      { label: "Type", value: "Cast / Extruded" },
      { label: "Colours", value: "Clear + tints" },
    ],
  },
  {
    slug: "hdpe-sheet",
  ...
  },
  {
    ...
    category: "Display",
    tagline: "Retractable roll-up stands for instant brand display",
    features: [
      "Premium aluminium retractable base",
      "Tool-free setup in seconds",
      "Carry bag included",
    ],
    applications: ["Exhibitions", "Retail", "Events"],
    weatherResistance: "Indoor display",
    inStock: true,
    accentFrom: "#FBBF24",
    accentTo: "#F97316",
    specs: [
      { label: "Size", value: "2×5 / 3×6 ft" },
      { label: "Base", value: "Standard / Premium" },
      { label: "Setup", value: "Retractable" },
      { label: "Includes", value: "Print + bag" },
    ],
  },
];
